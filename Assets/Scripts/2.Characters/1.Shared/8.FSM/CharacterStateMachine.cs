...
namespace WutheringWaves
{
    ...
    public class CharacterStateMachine : MonoBehaviour
    {
        ...
        [Tooltip("输入读取器")]
        public CharacterInputReader InputReader;
        [Tooltip("输入缓冲器")]
        ...
        public void Initialize(CharacterCore core, CharacterData data, Animator anim,
            CharacterController controller, CharacterMovement movement, CharacterInputReader inputReader, InputBuffer inputBuffer, CharacterAttack attack,CharacterManifestation Manifest)
        {
            // 注入依赖
            _core = core;
            characterData = data;
