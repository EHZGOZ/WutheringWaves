...
namespace WutheringWaves
{
    ...
    public class CharacterDataSO : ScriptableObject
    {
        ...
        [SerializeField] internal AnimationConfigSO animationConfigSO;
        #endregion
        ...
        [SerializeField] internal MovementConfigSO movementConfigSO;
        #endregion

        #region 武器相关
        [Header("=== 武器配置 ===")]
        [Tooltip("角色武器配置（御剑轨迹、武器表现等）")]
        [SerializeField] internal WeaponConfigSO weaponConfigSO;
        #endregion
