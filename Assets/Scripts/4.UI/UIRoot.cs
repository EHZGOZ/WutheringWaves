...
namespace WutheringWaves
{
    ...
    public class UIRoot : MonoBehaviour
    {
        ...
        [SerializeField] private CharacterCore _core; // 当前绑定的角色核心
        ...
        public CharacterCore Core => _core; // 当前角色核心
        ...
        public void InjectCharacterCore(CharacterCore core)
        {
            ...
            _core = core;
            characterHUDController?.SetCharacterCore(_core);
            miniMapController?.InjectDependencies(_core);
        }
        ...
        private void InitializeAndApplyLifecycle()
        {
            ...
            {
                characterHUDController.Initialize(_core, this);
            }
            ...
            {
                miniMapController.Initialize(_core);
            }
        ...
        private void ResolveDependencies()
        {
            ...
            if (_core == null)
            {
                _core = FindObjectOfType<CharacterCore>(true);
            }
        }
        ...
        private void SetCharacterInputEnabled(bool enabled)
        {
            ...
            if (enabled)
            {
                _core.EnablePlayerInput();
            }
            else
            {
                _core.DisablePlayerInput();
            }
        }

        private void SetPauseAndCursor(bool pause)
        {
            // 优先走时间服务统一暂停；若服务不可用，则回退到直接操作Time与Cursor。
